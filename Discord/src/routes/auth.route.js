...
import { deleteUser, googleUser, loginUser, registerUser, resendOtp, resetPassword, resetToken, sendOtp, verifyOtp  } from '../controllers/auth.controller.js'
...
router.post("/delete-account",authMiddleware,deleteUser)
